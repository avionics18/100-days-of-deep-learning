...
// - This script has been customized to the needs of this project
// - Original Project at https://github.com/avionics18/md-to-html-automation
    ...
    fs.readdirSync(inputDir).forEach((file) => {
        if (file.endsWith(".md")) {
            ...
            try {
                ...
                console.error(
                    `Failed to convert ${filePath} with marked. Error: ${err.message}`
                );
                return;
            }
            ...
            const finalHTML = `${HTML_START(
                ...
                superHeading,
                cssLink
            )}${htmlContent}${HTML_END(jsMainScript)}`;
